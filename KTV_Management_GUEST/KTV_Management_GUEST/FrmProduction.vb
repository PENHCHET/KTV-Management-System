...
Public Class FrmProduction
    ...
    Dim dtoPro As New ClsProduction
    Dim daoPro As New ClsProductionTransaction
    ...
    Public Sub FrmCategory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        dsPro = daoPro.getAllProductions()
        ...
        For j = 1 To dsPro.Tables(0).Rows.Count
            ...
            btCategory.Name = dsPro.Tables(0).Rows(j - 1)(1)
            ...
            btCategory.Text = dsPro.Tables(0).Rows(j - 1)(1)
